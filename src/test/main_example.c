...
static int sessionSetup(struct v2gEXIDocument* exiIn, struct v2gEXIDocument* exiOut) {
	...
	printf("\t\t EVCCID=%02x,%02x,%02x,%0x2,%02x,%02x\n",
								exiIn->V2G_Message.Body.SessionSetupReq.EVCCID.bytes[0], exiIn->V2G_Message.Body.SessionSetupReq.EVCCID.bytes[1],
								exiIn->V2G_Message.Body.SessionSetupReq.EVCCID.bytes[2], exiIn->V2G_Message.Body.SessionSetupReq.EVCCID.bytes[3],
								exiIn->V2G_Message.Body.SessionSetupReq.EVCCID.bytes[4], exiIn->V2G_Message.Body.SessionSetupReq.EVCCID.bytes[5]);
...
static int create_response_message(struct v2gEXIDocument* exiIn, struct v2gEXIDocument* exiOut) {
	...
	printf("debug create_response_message end = %i\n", errn);
	return errn;
}
